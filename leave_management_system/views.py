...
def userprofile(request):
	if(userauth(request)):
		try:
			...
			typ=q1.emp_type
			name1=fnam+" "+lnam
			print(fnam,lnam,address,email,dob,number,quote,typ,name1,q1.emp_img)
